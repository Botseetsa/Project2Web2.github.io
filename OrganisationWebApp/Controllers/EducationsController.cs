...
namespace OrganisationWebApp.Controllers
{
    public class EducationsController : Controller
    {
        ...
        public EducationsController(DimensionContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("EduId,EmpId,EduYears,EduField")] Education education)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EduId,EmpId,EduYears,EduField")] Education education)
        {
