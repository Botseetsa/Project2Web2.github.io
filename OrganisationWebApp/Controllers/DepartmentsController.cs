...
namespace OrganisationWebApp.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(DimensionContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DepId,EmpId,DepType,BusinessT,JobL,JobR")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DepId,EmpId,DepType,BusinessT,JobL,JobR")] Department department)
        {
